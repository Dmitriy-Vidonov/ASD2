...
*
* 6-я ошибка - AddKey() не возвращает корректный индекс добавленного элемента
* Переписал метод. Через линтер прогнал, упростил сложность. Как его так и FindKeyIndex()
*/
